ALTER TABLE dslq_sessions ADD COLUMN cohort_key TEXT;

CREATE INDEX IF NOT EXISTS idx_dslq_sessions_cohort_key
  ON dslq_sessions(cohort_key);
...
CREATE INDEX IF NOT EXISTS idx_dslq_feedback_cohort_key
